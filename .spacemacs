...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     (c-c++ :variables
            c-c++-default-mode-for-heaters 'c++-mode
...
before packages are loaded."
  ...
  ;; Set up Windmove for Org Mode
  (add-hook 'org-shiftup-final-hook 'windmove-up)
  (add-hook 'org-shiftleft-final-hook 'windmove-left)
  (add-hook 'org-shiftdown-final-hook 'windmove-down)
  (add-hook 'org-shiftright-final-hook 'windmove-right)

  ;; Setup shortcut to my journal
  (global-set-key (kbd "C-c w")
                  (lambda () (interactive) (find-file "~/org/work.org")))
  (global-set-key (kbd "C-c s")
                  (lambda () (interactive) (find-file "~/dev/copilot/surrogate/surrogate.cpp")))

  ;; Setup registers
  (set-register ?s (cons 'file "~/.spacemacs"))
  (set-register ?p (cons 'file "~/Papers/"))
  (set-register ?c (cons 'file "~/dev/copilot/"))
